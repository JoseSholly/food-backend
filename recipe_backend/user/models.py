...
import uuid
from .utils import GENDER_CHOICES, validate_dietary_restrictions
...
class User(AbstractUser):
    ...
    gender = models.CharField(choices= GENDER_CHOICES, max_length=10,null=True, default=None, help_text=_("The gender of user"))
    ...
    dietary_restrictions = models.JSONField(
        ...
        validators=[validate_dietary_restrictions],
    )
